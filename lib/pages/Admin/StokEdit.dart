...
class StokEditPage extends StatefulWidget {
  @override
  _StokEditPageState createState() => _StokEditPageState();
}

class _StokEditPageState extends State<StokEditPage> {

  TextEditingController judulController = new TextEditingController(text: 'Beras C4 Super');
  TextEditingController deskripsiController = new TextEditingController(text: '*deskripsi lorem ipsum dolor sit amet');
  TextEditingController stokController = new TextEditingController(text: '10');
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text('Edit Sembako', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold, color: Const().textColorDark),),
